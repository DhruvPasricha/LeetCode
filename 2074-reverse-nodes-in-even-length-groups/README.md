...
<pre style="position: relative;"><strong>Input:</strong> head = [5,2,6,3,9,1,7,3,8,4]
...
<pre style="position: relative;"><strong>Input:</strong> head = [1,1,0,6]
...
<pre style="position: relative;"><strong>Input:</strong> head = [1,1,0,6,5]
