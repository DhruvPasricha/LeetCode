[Discussion Post (created on 18/11/2021 at 8:52)](https://leetcode.com/problems/numbers-at-most-n-given-digit-set/discuss/1633426/C%2B%2B-Digit-DP-Memoization-Solution)  
...
<pre style="position: relative;"><strong>Input:</strong> digits = ["1","3","5","7"], n = 100
...
<pre style="position: relative;"><strong>Input:</strong> digits = ["1","4","9"], n = 1000000000
...
<pre style="position: relative;"><strong>Input:</strong> digits = ["7"], n = 8
