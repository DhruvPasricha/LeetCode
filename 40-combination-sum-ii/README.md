...
<pre style="position: relative;"><strong>Input:</strong> candidates = [10,1,2,7,6,1,5], target = 8
...
<pre style="position: relative;"><strong>Input:</strong> candidates = [2,5,2,1,2], target = 5
<strong>Output:</strong> 
[
[1,2,2],
[5]
