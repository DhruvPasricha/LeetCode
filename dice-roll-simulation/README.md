...
<pre style="position: relative;"><strong>Input:</strong> n = 2, rollMax = [1,1,2,2,2,3]
...
<pre style="position: relative;"><strong>Input:</strong> n = 2, rollMax = [1,1,1,1,1,1]
<strong>Output:</strong> 30
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong>Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> n = 3, rollMax = [1,1,1,2,2,3]
